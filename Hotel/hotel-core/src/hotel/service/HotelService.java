...
public class HotelService {
    ...
    public List<Room> getAvailableRooms() { return roomDao.findAvailable(); }
    public Room getRoomByNumber(int n) { return roomDao.findById(n).orElse(null); }

    public List<Guest> getAllGuests() { return guestDao.findAll(); }
    public Guest getGuestById(String id) { return guestDao.findById(id).orElse(null); }
    public List<Guest> getGuestsByRoom(int roomNumber) { return guestDao.findByRoomNumber(roomNumber); }

    public List<Service> getAllServices() { return serviceDao.findAll(); }
    public Service getServiceById(String id) { return serviceDao.findById(id).orElse(null); }
